...
// MARK: - PorbyConfiguration

public struct PorbyConfiguration: Sendable {
    ...
    public static let `default` = PorbyConfiguration()
...
public extension PorbyConfiguration {
    struct Filter: Sendable {
        ...
        public var minimumLevel: PorbyLogLevel = .verbose

        /// Per-category minimum level override.
        public var categoryLevels: [PorbyCategory: PorbyLogLevel] = [:]

        /// Completely disabled categories.
        public var disabledCategories: Set<PorbyCategory> = []

        public init() {}

        public func shouldLog(level: PorbyLogLevel, category: PorbyCategory) -> Bool {
